			  		...
			  		<div id="sidebar-wrapper" style="position: fixed;">
						...
						<div class="row">
	  					...
	  					<ul class="sidebar-nav">
	  						...
	  						<li><span rel="tab_report"><i class="far fa-clipboard"></i> Report</span></li>
			  		...
			  		<div id="page-content-wrapper">
			  			<div class="container-fluid">
			  				...
			  				<div class="tab-content" style="margin-top: 0px;">
			  					...
			  					<!-- DYNAMIC TAB -->
									<!-- <div class="tab-pane active" id="pane_report">
										<div class="panel panel-default" style="border-top: 0px; padding: 5px;">
											...
											<div class="panel-body">
												<div class="row">
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-chalkboard-teacher card-img-top" style="color:purple; font-size: 80px; padding-top: 15px;"></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color:purple;">Staff</h5>
														    <button id="btn_staff" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/staff.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-user-graduate card-img-top" style="color:#673ab7; font-size: 80px; padding-top: 15px;"></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color: #673ab7;">student</h5>
														    <button id="btn_student" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/student.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>	
													</div>
													...
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-receipt card-img-top" style="color:indigo; font-size: 80px; padding-top: 15px;"></i>
														  	<i class=""></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color:indigo;">Fees</h5>
														    <button href="#" id="btn_fees" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/fees.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-money-check card-img-top" style="color:#311b92; font-size: 80px; padding-top: 15px;"></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color:#311b92;">Salary</h5>
														    <button id="btn_salary" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/salary.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-calendar-check card-img-top" style="color:#1a237e ; font-size: 80px; padding-top: 15px;"></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color:#1a237e ;">Attendance</h5>
														    <button href="#" id="btn_attend" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/attendence.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>	
													</div>
													...
													<div class="col-md-4">
														<div class="card" style="width: 250px; height: 250px;">
														  <div class="rounded-circle text-center" style="height:120px; width: 120px; margin: 5% 25% 0% 25%;">
														  	<i class="fas fa-calculator card-img-top" style="color:#0d47a1; font-size: 80px; padding-top: 15px;"></i>
														  </div>
														  <div class="card-body">
														    <h5 class="card-title text-center" style="color:#0d47a1;">Income And Expenses</h5>
														    <button href="#" id="btn_ie" class="btn btn-outline-light" style="margin: 0% 0% 0% 15%; width: 150px;" onclick="window.open('../reports/income_expense.report.php','_blank','height=650,width=1300,toolbar=no,left=0');">View Report</button>
														  </div>
														</div>
													</div>
												</div>
							...
							<div id="footer-wrapper">
								<div class="row">
									<div class="col-md-3 mr-auto" style="padding-left: 75px;">
										...
										<p><a href="../promote/promote.php" target="_blank" class="btn btn-outline-info">Promote</a></p>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="alert alert-primary" role="alert" id="notice_board">
												...
												<h6>Attended</h6>
												<p><?php echo $totPresent['totPresent']; ?>/18</p>
											</div>
										</div>
									</div>
									<br/>
			...
			var salary_pi = new Chart(ctx,{
				...
				data:{
					...
					datasets:[{
						...
						data:[<?php echo $staff['paidSalary']; ?>,<?php echo ($staff['totalSalary']*11) - $staff['paidSalary']; ?>]
					}]
				},
			});
			...
			var salary_pi = new Chart(ctx,{
				...
				data:{
					...
					datasets:[{
						...
						data:[<?php echo $totPresent['totPresent']; ?>,totalDaysInMonth[date.getMonth()]]
					}]
				},
			});
		});
